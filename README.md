            ...
            <div class="container-fluid">
                <div class="row d-flex align-items-center p-3 border-bottom">
                    ...
                    <div class="col-md-2 text-left">
                            <a href="User.postman_collection.json" class="btn btn-sm btn-primary btn-rounded" download>
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="api-information">
                                    ...
                                    <div class="collection-description">
                                        <p>API REST de cadastro de autenticação de usuários usando tokens **JWT** como meio de autenticação.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row row-no-padding row-eq-height">
                            <div class="col-md-6 col-xs-12 section">
                                <div class="api-information" id="1">
                                    ...
                                    <div class="url">localhost:8000/api/register</div>
                                    
                                    <div class="description request-description">
                                        <p><p>Recebe as informações do usuário em formato JSON com os seguintes campos: <strong>name, cpf e password. O campo role é obrigatório.</strong> Se o campo <strong>role</strong> não for informado, o usuário será comum. Caso a role for igual a &ldquo;A&rdquo;, o usuário será administrador</p></p>
                                    </div>
                        ...
                        <div class="row row-no-padding row-eq-height">
                            <div class="col-md-6 col-xs-12 section">
                                <div class="api-information" id="2">
                                    ...
                                    <div class="url">localhost:8000/api/login</div>
                                    
                                    <div class="description request-description">
                                        <p><p>O usuário autenticado receberá um <strong>token JWT</strong> de acesso e poderá acessar o endpoint de usuários.</p></p>
                                    </div>
                                ...
                                <div class="api-information" id="3">
                                     <div class="heading">
                                        <div class="name">
                                            ...
                                            User Page <span class="lock-icon"></span>
                                        </div>
                                     </div>
                                    <div class="url">localhost:8000/api/users</div>
                                    
                                    <div class="description request-description">
                                        <p><p>Todos os usuários autenticados poderão visualizar os usuários cadastrados.</p></p>
                                    </div>
                            ...
                            <div class="col-md-6 col-xs-12 examples">
                                <div class="sample-request">
                                    ...
                                    <div class="responses-index">
                                        <div class="dropdown response-name">
                                            <button class="btn   responses-dropdown truncate" type="button" id="f678f251-1750-4e3a-b5d8-05b4c6b0fb37_dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                              <span id="selected" class="response-name-label">User Page</span>
                                                <span class="caret"></span>

                                            </button>

                                            <ul class="dropdown-menu" aria-labelledby="f678f251-1750-4e3a-b5d8-05b4c6b0fb37_dropdown">
                                                <li class="truncate" data-request-info="3" data-response-info="response_3">User Page</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="formatted-requests " data-request-id="3"  data-id="response_3">
                                    <div class="request code-snippet">
                                        <div>
                                            <pre class="click-to-expand-wrapper is-snippet-wrapper " data-title="User Page">
                                                <code class="is-highlighted">
                                ...
                                <div class="api-information" id="4">
                                     <div class="heading">
                                        <div class="name">
                                            ...
                                            Change user <span class="lock-icon"></span>
                                        </div>
                                     </div>
                                    <div class="url">localhost:8000/api/users/edit/2</div>
                                    
                                    <div class="description request-description">
                                        <p><p>Somente usuários admin poderão acessar esse endpoint. O administrador deverá indicar o id do usuário a ser editado via query string e enviar as mudanças no corpo da requisição.</p></p>
                                    </div>
                                    ...
                                    <div class="request-body">
                                        ...
                                        <hr>
                                            <div class="raw-body code-snippet">
                                              <pre class="body-block click-to-expand-wrapper is-snippet-wrapper " data-title="Change user">
                                                  <code>
                                                    
{
    "name": "Marcinha",
    "password": "marcinha123",
    "cpf": "05012119266"
}
                                                  </code>
                                              </pre>
                            ...
                            <div class="col-md-6 col-xs-12 examples">
                                <div class="sample-request">
                                    ...
                                    <div class="responses-index">
                                        <div class="dropdown response-name">
                                            <button class="btn   responses-dropdown truncate" type="button" id="f678f251-1750-4e3a-b5d8-05b4c6b0fb37_dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                              <span id="selected" class="response-name-label">Change user</span>
                                                <span class="caret"></span>

                                            </button>

                                            <ul class="dropdown-menu" aria-labelledby="f678f251-1750-4e3a-b5d8-05b4c6b0fb37_dropdown">
                                                <li class="truncate" data-request-info="4" data-response-info="response_4">Change user</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="formatted-requests " data-request-id="4"  data-id="response_4">
                                    <div class="request code-snippet">
                                        <div>
                                            <pre class="click-to-expand-wrapper is-snippet-wrapper " data-title="Change user">
                                                <code class="is-highlighted">
PATCH localhost:8000/api/users/edit/2

{
    ...
    <script type="application/javascript">
        var data = [{'text': 'Register', 'href': '#1', 'method': 'POST'}, {'text': 'Login', 'href': '#2', 'method': 'POST'}, {'text': 'User Page', 'href': '#3', 'method': 'GET'}, {'text': 'Change user', 'href': '#4', 'method': 'PATCH'}]
        $('#tree').treeview({
            data: data,
            levels: 10,
